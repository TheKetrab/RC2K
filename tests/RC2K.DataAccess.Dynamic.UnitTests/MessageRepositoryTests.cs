...
public class MessageRepositoryTests
{
    ...
    public void SetUp()
    {
        (var db, _container, var mapper, var envProvider) = 
            ContainerMockHelper.SetUpMocks<DateTimeMessageMapper>("Statistics");

        _sut = new MessageRepository(db.Object, mapper.Object, envProvider.Object);

        _container.
            Setup(x => x.ReadItemAsync<MessageModel>(
                It.IsAny<string>(),
    ...
    public async Task Container_WhenUsePartitionKey_ShouldEqualEntityName()
    {
        ...
        //Assert
        _container
            .Verify(x => x.ReadItemAsync<MessageModel>(
